...
impl<'a> System<'a> for IndexTileLighting {
    ...
    fn run(&mut self, data: Self::SystemData) {
        ...
        tile_lighting.clear();
        let (_entities, has_viewshed_storage, has_position_storage, has_light_source_storage) =
            data;
        for (has_viewshed, has_position, has_light_source) in (
            ...
            .join()
        {
            ...
            for lit_position in viewshed.visible_positions.iter() {
                ...
                let altered_lighting =
                    light_source.transform_color_at(current_lighting, position, lit_position);
